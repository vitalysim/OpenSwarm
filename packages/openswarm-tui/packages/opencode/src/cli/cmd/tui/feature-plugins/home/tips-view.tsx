...
const TIPS = AgencyProduct.tips([
  ...
  "Place TUI settings in {highlight}~/.config/agentswarm/tui.json{/highlight} for global config",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.agentswarm/command/{/highlight} to define reusable custom prompts",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.agentswarm/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.agentswarm/plugin/{/highlight} for event hooks",
